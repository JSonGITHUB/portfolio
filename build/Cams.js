...
function showCams() {
    ...
    var x = 0;
    var cams = [4786, 4241, 68366, 4242, 128083, 4773, 4771, 4772, 4789, 4790, 4791, 4238, 139590, 139591, 4787, 139340, 4783, 4246, 4812, 4248, 4252, 4253, 4254];
    //    document.getElementById("resume").style.opacity = 0;
    //    document.getElementById("resume").innerHTML = "";
    for (x in cams) {
        document.getElementById("resume").innerHTML = document.getElementById("resume").innerHTML + camPrefix + cams[x] + camSuffix;
    }
